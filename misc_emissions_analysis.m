    ...
    methods(Static = true)
        ...
        function [start_dates, end_dates, time_period, legend_id] = select_start_end_dates(time_period, varargin)
            ...
            elseif strcmpi(time_period, 'beg_2yr')
                start_dates = {datenum(2005, start_month, 1), datenum(2006, start_month, 1), datenum(2007, start_month, 1)};
                end_dates = {eomdate(2005, end_month), eomdate(2006, end_month), eomdate(2007, end_month)};
                legend_id = '2006*';
...
%                     changes.hcho_vcds(:,2) = misc_emissions_analysis.avg_vcds_around_loc(second_locs.locs, second_time_period, second_weekdays, 'radius', avg_radius, 'species', 'hcho');
        ...
        function make_location_wrf_avgs_file(time_periods, overwrite)
            ...
            for i_time = 1:n_times
                ...
                field_2d = 'Averaged';
                field_3d = 'Profile';
                data_struct_2d = make_empty_struct_from_cell(wrf_2d_vars, nan(size(tmp_locs.WindUsedBool,1),1));
                data_struct_3d = make_empty_struct_from_cell(wrf_3d_vars, nan(size(tmp_locs.WindUsedBool,1),1));
                tmp_locs.WRFData.(field_2d) = data_struct_2d;
                tmp_locs.WRFData.(field_3d) = data_struct_3d;
